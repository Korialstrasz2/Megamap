...
with sync_playwright() as p:
    ...
    if args.inline:
        ...
        for name in ['app.js','assets.js','engine.js','editor-core.js','render.js','i18n.js']:html=html.replace('<script src="src/'+name+'"></script>','<script>'+(ROOT/'src'/name).read_text(encoding='utf-8')+'</script>')
