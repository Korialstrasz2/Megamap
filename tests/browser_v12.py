...
with sync_playwright() as p:
    ...
    if args.inline:
        ...
        for name in ['battle-arena.js','battle-materials.js','battle-hq.js','app.js','assets.js','encounter-content.js','battle-landscapes.js','battle.js','battle-render.js','battle-ui.js','engine.js','editor-core.js','render.js','i18n.js']:html=html.replace('<script src="src/'+name+'"></script>','<script>'+(ROOT/'src'/name).read_text(encoding='utf-8')+'</script>')
